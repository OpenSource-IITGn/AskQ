...
} from "../../GraphQL/Mutations/createPostMutation";
...
function AddQuestionForm(props) {
  const [
    createPostMutation,
    createPostMutationResults,
  ] = useCreatePostMutation();
  const [
    updatePostMutation,
    updatePostMutationResults,
  ] = useUpdatePostMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = isEditing
        ? await updatePostMutation(pid, title, body, tags)
        : await createPostMutation(postType, quesid, title, body, tags);
    ...
    <Form onSubmit={handleSubmit} fluid>
      ...
      <FormGroup>
        ...
        <MdEditor
          ...
          type="question"
          placeHolder="Write body of Question here..."
        />
      </FormGroup>
